...
class Annotation{
	...
	protected $annotationArray 			= null;
	protected $annontationFormated 		= null;
	protected $annontationFormatedForm 	= null;

	public function __construct($myClass, $formated=false){
		static::learnPropertyAnnotations($myClass);
		static::formatedToLaravel();
	}

	protected function learnPropertyAnnotations($myClass){
	...
	protected function formatedToLaravel(){
